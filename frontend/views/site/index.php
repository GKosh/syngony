                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-6">
                        <div id="templatemo_logo">
                            <h1><a rel="nofollow" href="#" title="CubyFix"></a></h1>
                        </div> <!-- /.logo -->
                    </div> <!-- /.col-md-4 -->
        ...
        <ul class="bxslider">
            ...
            <li>
                ...
                <div class="container caption-wrapper">
                    <div class="slider-caption">
                        <h2>Create things Using CubyFix</h2>
                    </div>
                </div>
            </li>
            <li>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="service-item">
                        ...
                        <h3>High Quality</h3>
                        <p>Sprint is free responsive <a href="http://www.templatemo.com">website template</a> using HTML5 CSS3 and Bootstrap framework. Feel free to download, edit and use it for your websites.</p>
                    </div> <!-- /.service-item -->
                </div> <!-- /.col-md-3 -->
                <div class="col-md-3 col-sm-6">
                    <div class="service-item">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-offset-2 col-md-8 text-center bigger-text">
                    <p>templatemo provides a lot of <a href="http://www.templatemo.com/page/1">free website templates</a> for everyone. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores, itaque vero facere laudantium voluptas temporibus mollitia nisi deleniti illo minima quisquam corporis possimus nesciunt.</p>
                </div>
...
<div class="site-index">
    ...
    <div class="jumbotron">
        ...
        <p class="lead">You have successfully created your Yii-powered application.1</p>
